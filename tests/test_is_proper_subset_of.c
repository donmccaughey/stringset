...
test_is_proper_subset_of(void)
{
    ...
    assert(!stringset_is_proper_subset_of(set1, set3));
    
    assert(!stringset_is_proper_subset_of(set2, set1));
    assert(!stringset_is_proper_subset_of(set2, set3));
    
    assert(stringset_is_proper_subset_of(set3, set1));
    assert(!stringset_is_proper_subset_of(set3, set2));
    
    assert(!stringset_is_proper_subset_of(set3, set3));
    assert(!stringset_is_proper_subset_of(set3, set3_dup));
    assert(!stringset_is_proper_subset_of(set3_dup, set3));
    
    struct stringset *empty_set = stringset_alloc();
    assert(empty_set);
    
    assert(stringset_is_proper_subset_of(empty_set, set1));
    assert(stringset_is_proper_subset_of(empty_set, set2));
    assert(stringset_is_proper_subset_of(empty_set, set3));
    assert(!stringset_is_proper_subset_of(empty_set, empty_set));
    
    assert(!stringset_is_proper_subset_of(set1, empty_set));
    assert(!stringset_is_proper_subset_of(set2, empty_set));
    assert(!stringset_is_proper_subset_of(set3, empty_set));
